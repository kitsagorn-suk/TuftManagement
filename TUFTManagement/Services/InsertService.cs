...
namespace TUFTManagement.Services
{
    public class InsertService
    {
        ...
        public InsertLoginModel InsertEmpProfileService(string authorization, string lang, string platform, int logID,
            InsertEmpProfileDTO insertEmpProfileDTO, int roleID, int userID)
        {
            if (_sql == null)
            {
            ...
            try
            {
                ...
                int chkUnique = _sql.CheckUniqueNameInsertEmp(insertEmpProfileDTO, 0);
                ...
                {
                    value.data = _sql.InsertEmpProfile(insertEmpProfileDTO, userID);
                }
                else
                {
